...
// if we use {} we should add a return statement but if we open a () no need for return
      ...
      <ScrollView 
        contentContainerStyle={{ paddingBottom: 80 }}>
          ...
          <View className='flex-col items-start justify-center mt-5 px-5'>
            ...
            <MovieInfo label="Generes" value={movie?.genres?.map((genre) => genre.name).join(' - ') || 'N/A'} />

            <View className='flex flex-row items-center gap-x-10 mt-2'>
